        ...
        <div class="col">
          ...
          >
            <template v-slot:before>
              <q-avatar size="xl">
                <img
                  src="https://en.gravatar.com/userimage/228366760/8b2a3cf0504385a5251c3dbd246e90b4.jpeg?size=256"
                />
              </q-avatar>
            </template>
          </q-input>
          ...
          <q-item v-for="qweet in qweets" :key="qweet.id" class="qweet q-py-md">
            ...
            <q-item-section>
              <q-item-label class="text-subtitle1">
                <strong> Mangesh</strong>
                <span class="text-grey-7">
                  @mangesh // eslint-disable-next-line vue/no-deprecated-filter
